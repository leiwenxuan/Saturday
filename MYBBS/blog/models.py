...
class UserInfo(AbstractUser):
    ...
    avatar = models.FileField(
        upload_to="avatars/", default="avatars/default.png", verbose_name="头像")
    create_time = models.DateTimeField(auto_now_add=True)

    blog = models.OneToOneField(
        to="Blog", to_field="nid", null=True, on_delete=models.CASCADE)
...
class Tag(models.Model):
    ...
    blog = models.ForeignKey(
        to="Blog", to_field="nid", on_delete=models.CASCADE)  # 所属博客
...
class Article(models.Model):
    ...
    user = models.ForeignKey(
        to="UserInfo", to_field="nid", on_delete=models.CASCADE)
...
class ArticleUpDown(models.Model):
    ...
    nid = models.AutoField(primary_key=True)
    user = models.ForeignKey(
        to="UserInfo", null=True, on_delete=models.CASCADE)
    article = models.ForeignKey(
        to="Article", null=True, on_delete=models.CASCADE)
...
class Comment(models.Model):
    ...
    user = models.ForeignKey(
        to="UserInfo", to_field="nid", on_delete=models.CASCADE)
    content = models.CharField(max_length=255, verbose_name='评论数')  # 评论内容
    create_time = models.DateTimeField(auto_now_add=True)
