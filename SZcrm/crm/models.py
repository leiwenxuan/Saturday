...
class ClassList(models.Model):
    ...
    class_type = models.CharField(choices=class_type_choices, max_length=64, verbose_name='班类型', blank=True,
                                  null=True)
    ...
    def show_teacher(self):
        return '|'.join([i['name'] for i in self.teachers.all().values('name')])
